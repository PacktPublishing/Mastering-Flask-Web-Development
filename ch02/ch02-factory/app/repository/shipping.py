...
from app.model.db import Shipping
...
class ShippingRepository:
    ...
    def insert(self, ship:Shipping) -> bool:
        try:
            ...
            return True
              ...
              current_app.logger.error(f'ShippingRepository insert error: {e}') 
        return False
    ...
    def update(self, id:int, details:Dict[str, Any]) -> bool:
        try:
            ...
            current_app.logger.error(f'ShippingRepository update error: {e}') 
        return False  
    ...
    def select_all(self) -> List[Any]:
        ...
        current_app.logger.error('ShippingRepository retrieved all record')
        return users
